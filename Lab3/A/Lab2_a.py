...
class Lab2_a(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab2_a")
        ...
        self._GTX_range = Range(0, 30, 1, 3, 200)
        ...
        self.analog_sig_source_x_1 = analog.sig_source_c(samp_rate, analog.GR_SQR_WAVE, 1000, A, 0, 0)
...
def main(top_block_cls=Lab2_a, options=None):
